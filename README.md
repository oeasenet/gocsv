...
[![GoDoc](https://godoc.org/github.com/oeasenet/gocsv?status.png)](https://godoc.org/github.com/gocarina/gocsv)

Installation
=====

```go get -u github.com/oeasenet/gocsv```
